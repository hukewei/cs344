                   ...
                   const float* const filter, const int filterWidth)
{
  ...
  //
	...
	int tid = absolute_image_position_x + absolute_image_position_y * numCols;
                      ...
                      unsigned char* const blueChannel)
{
  ...
  int absolute_image_position_y=blockIdx.y*blockDim.y+threadIdx.y;
   ...
   int tid = absolute_image_position_x + absolute_image_position_y * numCols;
   uchar4 pixel = inputImageRGBA[tid];
   redChannel[tid] = pixel.x;
   greenChannel[tid] = pixel.y;
   blueChannel[tid] = pixel.z;
}
